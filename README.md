...
7. Go to _root/functions/src/endpoints/endpoints_ -> In both endpoint files, update the variable `serviceForLocalTesting` with the name of the new subroute / cloud function (as spelt/defined in _Microservice.ts_)
